...
| [`roadmap/`](./roadmap/) | Forward-facing plans, one file per phase. Currently: Phase 5 (feedback + library filters). |
| [`log/`](./log/) | Append-only decision records, one file per work day (`YYYY-MM-DD.md`). |

## Quick navigation

- **"What's the status?"** → [`STATE.md`](./STATE.md)
- **"What's next?"** → [`roadmap/phase-5-feedback-library.md`](./roadmap/phase-5-feedback-library.md)
