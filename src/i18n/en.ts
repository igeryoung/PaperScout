...
export const messages = {
  ...
  paperDetail: {
    ...
    abstractShowMore: 'Show more',
    abstractShowLess: 'Show less',
    aiDigest: 'AI Digest',
    digestTldr: 'TL;DR',
    digestProblemMotivation: 'Problem & Motivation',
    digestKeyContributions: 'Key Contributions',
    digestMethodOverview: 'Method Overview',
    digestExperiments: 'Experiments',
    digestExperimentsDatasets: 'Datasets',
    digestExperimentsBaselines: 'Baselines',
    digestExperimentsMetrics: 'Metrics',
    digestExperimentsMainResults: 'Main Results',
    digestExperimentsAblation: 'Ablation',
    digestResultsInterpretation: 'Results Interpretation',
    digestStrengthsLimitations: 'Strengths & Limitations',
    digestStrengths: 'Strengths',
    digestLimitations: 'Limitations',
