...
After identifying ~30 candidate titles + arXiv IDs from Step A, fetch each paper's abstract via its arXiv abstract page (GitHub allows WebFetch to `raw.githubusercontent.com`; for arXiv use the search):
